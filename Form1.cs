...
namespace ExplorerRobot
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            int hiz = trackBar3.Value; ;        //trackBar3.Value;   //  bir timer oluşturup içine kodları yaz, gönderilen değer sürekli yenilensin. Hız kontrolü sağla.
            ...
            if (!serialport.IsOpen)
            {
                try
                {
                   ...
                   // button13.Enabled = true;
                    ...
                    //richTextBox1.Text += "Bağlantı Sağlandı." + "  " + DateTime.Today + "  " + DateTime.Now.ToLongTimeString() + Environment.NewLine;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //richTextBox1.Text += "Bağlantı Kesildi." + "  " + DateTime.Today + "  " + DateTime.Now.ToLongTimeString() + Environment.NewLine;
            button1.Enabled = true;
            button2.Enabled = false;
        ...
        {
            if (serialport.IsOpen == true)   //servo sağa-sola kontrol
            {
        ...
        {
            if (serialport.IsOpen == true)   //servo yukarı-aşağı kontrol
            {
        ...
        private void trackBar3_Scroll(object sender, EventArgs e)    //Hız Kontrolü
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                trackBar2.Value -= 2;  // servo yukarı
                label5.Text = trackBar2.Value.ToString();
                veri[2] = Convert.ToByte(trackBar2.Value);
                gonder();
            }
